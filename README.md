...
- Clone the repository: `git clone https://github.com/skhetcho/DriverHive.git`
- `cd DriverHive`
- `npm insall`
- `npm start`

## Documentation
The documentation for the Material Kit React is hosted at their [website](https://demos.creative-tim.com/material-kit-react/#/documentation/tutorial).
